...
type MessageInputProps =
  ...
  export function MessageInput({
    ...
    stop,
    isGenerating,
    onSubmit, // Pass the onSubmit prop from the parent
    ...props
  }: MessageInputProps) {
    ...
    const onKeyDown = (event: React.KeyboardEvent<HTMLTextAreaElement>) => {
      if (submitOnEnter && event.key === "Enter" && !event.shiftKey) {
        event.preventDefault();
        onSubmit?.(); // Call the onSubmit handler passed from the parent
      }
        ...
        <div className="absolute right-3 top-3 flex gap-2">
          ...
          {isGenerating && stop ? (
            ...
            <Button
              ...
              onClick={onSubmit} // Call the onSubmit handler passed from the parent
